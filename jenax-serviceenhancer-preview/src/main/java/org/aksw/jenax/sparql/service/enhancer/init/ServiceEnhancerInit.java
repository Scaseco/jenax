...
package org.aksw.jenax.sparql.service.enhancer.init;
...
import org.aksw.jenax.sparql.service.enhancer.algebra.TransformSE_EffectiveOptions;
import org.aksw.jenax.sparql.service.enhancer.algebra.TransformSE_JoinStrategy;
import org.aksw.jenax.sparql.service.enhancer.assembler.DatasetAssemblerServiceEnhancer;
import org.aksw.jenax.sparql.service.enhancer.assembler.ServiceEnhancerVocab;
import org.aksw.jenax.sparql.service.enhancer.function.cacheRm;
import org.aksw.jenax.sparql.service.enhancer.impl.ChainingServiceExecutorBulkConcurrent;
import org.aksw.jenax.sparql.service.enhancer.impl.ChainingServiceExecutorBulkServiceEnhancer;
import org.aksw.jenax.sparql.service.enhancer.impl.ServiceOpts;
import org.aksw.jenax.sparql.service.enhancer.impl.ServiceOptsSE;
import org.aksw.jenax.sparql.service.enhancer.impl.ServiceResponseCache;
import org.aksw.jenax.sparql.service.enhancer.impl.ServiceResultSizeCache;
import org.aksw.jenax.sparql.service.enhancer.impl.util.DynamicDatasetUtils;
import org.aksw.jenax.sparql.service.enhancer.impl.util.Lazy;
import org.aksw.jenax.sparql.service.enhancer.impl.util.VarScopeUtils;
import org.aksw.jenax.sparql.service.enhancer.impl.util.iterator.QueryIteratorMaterialize;
import org.aksw.jenax.sparql.service.enhancer.init.ServiceEnhancerConstants;
import org.aksw.jenax.sparql.service.enhancer.init.ServiceEnhancerInit;
import org.aksw.jenax.sparql.service.enhancer.pfunction.cacheLs;
    ...
    implements JenaSubsystemLifecycle
{
    ...
    /**
     * Initialize the SERVICE &lt;collect:&gt; { } feature.
     * This collects all bindings of the graph pattern into a list and serves them
     * from the list. The 'concurrent' feature creates separate threads with read transactions.
     * Updates can only be made after all the read transactions have ended.
     * With collect, the data from the read transactions can be collected before passing it to the update.
     */
