...
public interface OsreoTerms {
    public static final String O = "https://w3id.org/osreo/ontology#";

    public static final String Shell = O + "Shell";
    public static final String LocatorCommand = O + "LocatorCommand";

    public static final String probeLocation = O + "probeLocation";
