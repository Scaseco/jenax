...
public class AccStateArray<I, E, K, V>
    ...
    // implements AccStateGon<I, E, K, V>
{
    ...
    public AccStateArray(Object matchStateId, AccStateTypeProduceNode<I, E, K, V> targetAcc) {
        super();
    ...
    public String toString() {
        return "AccStateArray(matches: " + matchStateId + ", currentInput: " + currentInput + ", " + targetAcc + ")";
    }
