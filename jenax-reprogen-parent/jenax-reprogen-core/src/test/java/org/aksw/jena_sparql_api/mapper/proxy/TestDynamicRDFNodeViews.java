...
//		TypeDecider typeDecider = new TypeDeciderImpl().scan(TestDynamicViews.class);
    ...
    public void testDynamicSetViewsWithTypes() {
        ...
        Assertions.assertEquals("http://www.example.org/Port",
        ...
        Assertions.assertEquals(6, port.getVessels(Vessel.class).size());

        // Remove the sailing yacht
        port.getVessels(SailingYacht.class).clear();

        Assertions.assertEquals(5, port.getVessels(Vessel.class).size());
        ...
        port2.setObject(sy1);
        Assertions.assertFalse(port2.getObject() instanceof SailingYacht);
        ...
        Assertions.assertTrue(port2.getObject() instanceof SailingYacht);

        RDFDataMgr.write(System.out, port2.getModel(), RDFFormat.TURTLE_PRETTY);
        System.out.println("Object is: " + port2.getObject());
        Assertions.assertEquals(sy1, port2.getObject());
    }
