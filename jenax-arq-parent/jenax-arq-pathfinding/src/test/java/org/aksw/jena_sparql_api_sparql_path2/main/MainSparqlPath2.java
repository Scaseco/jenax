...
public class MainSparqlPath2 {
    ...
    public static LookupService<Node, Map<Node, Number>> createJoinSummaryLookupService(QueryExecutionFactoryQuery qef, boolean reverse) {
    ...
    public static JoinSummaryService createJoinSummaryService(QueryExecutionFactoryQuery qef) {
     ...
     * @return
     */
    public static LookupService<Node, Map<Node, Number>> createListServicePredicates(QueryExecutionFactoryQuery qef, boolean reverse) {
        Query query = new Query();
