...
public class ResultSetWriterMarkdown implements ResultSetWriter {

    // ContentType.create("text/markdown", "utf-8")
    public static final Lang RS_Markdown = LangBuilder.create("SPARQL-Results-Markdown", "text/markdown")
            .addFileExtensions("md")
            .build();
    ...
    private static void output$(AWriter out, ResultSet resultSet, String colStart, String colSep, String colEnd, Context cxt) {
        ...
        try {
            ...
            // TODO This needs to print the mid row which looks like: | --- | --- |
            for ( int i = 0 ; i < lineWidth ; i++ )
                out.print('=') ;
            out.println() ;
