...
// A copy of DBSCAN from commons-math because the getNeighbors method is private so it
// can't be overridden to use a spatial index...
// In fact, having replaced private with protected is the only difference to the original version
...
public class DBSCANClusterer<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    protected List<T> getNeighbors(final T point, final Collection<T> points) {
