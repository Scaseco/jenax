    ...
    implements Evaluation<T>
{
    ...
    @Override public T eval(OpSemiJoin opSemiJoin, T left, T right) { return null; }
    @Override public T eval(OpAntiJoin opAntiJoin, T left, T right) { return null; }
    ...
    @Override public T eval(OpUnfold opUnfold, T subOp) { return null; }
}
