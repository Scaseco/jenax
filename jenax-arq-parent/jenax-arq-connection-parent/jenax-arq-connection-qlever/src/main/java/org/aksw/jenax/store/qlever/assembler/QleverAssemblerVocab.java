...
public class QleverAssemblerVocab {
    ...
    public static final Property dockerImage = ResourceFactory.createProperty(QleverAssemblerTerms.dockerImage);
    public static final Property dockerTag = ResourceFactory.createProperty(QleverAssemblerTerms.dockerTag);
